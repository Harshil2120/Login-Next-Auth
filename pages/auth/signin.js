        ...
        <div className="flex flex-col min-h-screen w-full items-center justify-center bg-gray-800 text-center">
          <div className="bg-white md:py-14 py-10 md:px-8 px-3 rounded-md">
            ...
            <div className="flex flex-col space-y-4 p-2 mt-5">
              <button
                className="group h-12 px-6 border-2 border-gray-300 rounded-xl transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100"
                onClick={() =>
                  signIn("google", {
              ...
              <button
                className="group h-12 px-6 border-2 border-gray-300 rounded-xl transition duration-300 hover:border-gray-400 focus:bg-blue-50 active:bg-blue-100"
                onClick={() =>
                  signIn("github", {
                    callbackUrl: "http://localhost:3000/chat",
                  })
